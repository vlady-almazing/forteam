...
function Chz(d){var c=['',''];z=Rnd(min[d],max[d]);if(96==z||47==z)z=95;c[0]+=String.fromCharCode(z);c[1]+=(z<100?'0':'')+z;
return c;}for(var i=0; i<=3; i++){if(3==i){for(var b=1; b<=5; min.pop(), max.pop(), b++){}
...
document.getElementById('i_agree_check').checked=true;u[3]=k[1];window.open(ht+u[0]+'&p='+u[5]+u[3]+'&m='+w);
